...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bhavin Parmar — Business Analyst, Developer & AI Builder" },
      { name: "description", content: "Premium portfolio of Bhavin Parmar — Business Analyst, Digital Marketer, Web Developer, AI Builder and Power BI enthusiast." },
      { name: "author", content: "Bhavin Parmar" },
